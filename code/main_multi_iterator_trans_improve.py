...
if __name__ == '__main__':
    ...
    model_transformer = Trans_DGA_Multi(num_classes=65, vocab_size=40)

    # 生成列表
    model_name_list = ['ANN_Multi', 'CNN_Multi', 'LSTM_Multi', 'MIT_Multi', 'BBYB_Multi', 'Transformer_improve_Multi']
